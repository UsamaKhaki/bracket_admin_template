        ...
        <nav class="nav">
            ...
            <div class="dropdown">
                <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
                    <span class="logged-name hidden-md-down">{{ ucwords(Auth::user()->username) }}</span>
                    <img src="http://via.placeholder.com/64x64" class="wd-32 rounded-circle" alt="">
                    <span class="square-10 bg-success"></span>
                </a>
                <div class="dropdown-menu dropdown-menu-header wd-200">
                    <ul class="list-unstyled user-profile-nav">
                        <li><a href="{{ route('page-setting-edit-profile') }}"><i class="icon ion-ios-person"></i> Edit Profile</a></li>
                        <li><a href="{{ route('page-setting-edit-profile') }}"><i class="icon ion-ios-gear"></i> Settings</a></li>
                        <li>
